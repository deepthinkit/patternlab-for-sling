 ...
 * Licensed under the MIT license
 */
/* not required - handled from backend to render Sightly templates, components and menu
try {
...
function waitForLoadAndAdjustHeight(iframe) {
  ...
  function sizeiframe(size,animate) {
    ...
    //document.getElementsByClassName('sg-viewport').contentWindow.postMessage(obj,targetOrigin);
